  ...
  {images.map((image) => (
    ...
    >
      ...
      />
        ...
        <Col xs={24} md={8} align="center" style={{ backgroundColor: " black",paddingTop : "20px", paddingBottom: "50px"}}>
        <Card
      hoverable
      style={{ width: 340 }}
      cover={
